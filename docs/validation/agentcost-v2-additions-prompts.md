# AgentCost v2 Additions: Drift Specification, Pilot Calibration, and Backtest Validation
...
These findings feed directly into AgentCost's documentation and the user-facing guidance for the `--traffic-mix` flag.
