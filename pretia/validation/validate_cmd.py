"""Logic for 'pretia validate' command: 20-vs-100 comparison test."""
...
from pretia.validation.scoring import CalibrationScore
...
def run_validation(
    ...
    from pretia.validation.scoring import score_projection
...
def format_validate_report(result: ValidateResult) -> str:
    ...
    lines: list[str] = []
    lines.append(f"Pretia Validation: {result.workflow}")
    lines.append("=" * 40)
    lines.append("")
    lines.append(
